    ...
    <section className="min-h-screen w-screen flex font-inter">
      ...
      <div className="bg-zinc-900 w-1/2 flex items-center justify-center">
        <div className="w-full max-w-md px-10 text-white flex flex-col">
          <h2 className="text-5xl font-semibold mb-8 text-left">Registre-se</h2>
          ...
          <div className="flex flex-col gap-6">
            ...
            <PrimaryButton value={"Criar Conta"} heigth={16} width={96} />
          </div>
          <p className="text-center mt-2">
            Já possui acesso?
            <Link to="/" className="text-blue-600 font-semibold ml-1 underline">
              Entrar
            </Link>
          </p>
        </div>
